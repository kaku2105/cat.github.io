...
import type { ILink, DialogOptions, ISignUpOptions, IContactInfo, IEmailVerification } from './types'
import { PrivacyStatus } from './constants'
...
type ComponentTypeMap = {
	...
	VerificationCodeDialog: {
		...
		actions: CommonActions & {
			...
			onCloseDialogCallback: () => void
			onSubmitCallback: (email: string, password: string, code: string) => Promise<void>
		}
	}
}
