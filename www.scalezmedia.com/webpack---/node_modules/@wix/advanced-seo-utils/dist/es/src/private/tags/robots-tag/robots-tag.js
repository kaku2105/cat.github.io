...
export var addRobotsTagIndexDirectiveIfMissing = function(tags) {
    var robotsTagValue = getValueByIdentifier(tags, IDENTIFIERS.ROBOTS);
    if (isRobotsDirectiveExists(robotsTagValue, ROBOTS_DIRECTIVES.NOINDEX)) {
        return tags;
    }
    var updatedRobotsTagValue = getRobotsTagValueWithDirective(robotsTagValue, INDEX);
    return updateValueByIdentifier(tags, IDENTIFIERS.ROBOTS, updatedRobotsTagValue);
};