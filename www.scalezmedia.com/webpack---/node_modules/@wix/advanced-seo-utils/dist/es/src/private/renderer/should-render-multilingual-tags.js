...
export var shouldRenderMultilingualTags = function(_a) {
    ...
    var veloTags = (veloOverrides === null || veloOverrides === void 0 ? void 0 : veloOverrides.tags) || [];
    return (!skipMultilingualForTpaPageId(itemType, tpaPageId) &&
