...
export var getSiteData = function(item) {
    ...
    return _a = {},
        ...
        _a[siteIDs.BUSINESS_LOCATION_STREET_ADDRESS] = [
            get(item, "context." + CONTEXT_PROPS.BUSINESS_LOCATION_STREET_NUMBER),
            get(item, "context." + CONTEXT_PROPS.BUSINESS_LOCATION_STREET),
        ]
        .join(' ')
        .trim(),
        _a[siteIDs.BUSINESS_LOCATION_DESCRIPTION] = get(item, "context." + CONTEXT_PROPS.BUSINESS_LOCATION_DESCRIPTION),
        _a[siteIDs.BUSINESS_LOCATION_FORMATTED] = get(item, "context." + CONTEXT_PROPS.BUSINESS_LOCATION_FORMATTED),
        ...
        _a[siteIDs.BUSINESS_SCHEMA_IMAGE] = (_b = get(item, "context." + CONTEXT_PROPS.BUSINESS_LOGO)) !== null && _b !== void 0 ? _b : get(item, "context." + CONTEXT_PROPS.SITE_OG_IMAGE),
        _a[siteIDs.BUSINESS_LOCALE] = get(item, "context." + CONTEXT_PROPS.BUSINESS_LOCALE),
        _a[siteIDs.BUSINESS_PHONE] = get(item, "context." + CONTEXT_PROPS.BUSINESS_PHONE),
