...
function init(services, contextWindow) {
    ...
    var defineCustomElement = function defineCustomElement(elementName, elementClass) {
    ...
    var defineWixImage = function defineWixImage(externalServices, environmentConsts) {
        var WixImage = wixImageWrapper(WixElement, externalServices, environmentConsts, contextWindow);
        defineCustomElement('wix-image', WixImage);
    };

    var defineWixBgImage = function defineWixBgImage(externalServices, environmentConsts) {
        var WixBgImage = wixBgImageWrapper(WixElement, externalServices, environmentConsts, contextWindow);
        defineCustomElement('wix-bg-image', WixBgImage);
    };

    var defineWixBgMedia = function defineWixBgMedia(externalServices) {
        var WixBgMedia = wixBgMediaWrapper(WixElement, _objectSpread({
            windowResizeService: windowResizeService
        }, externalServices), contextWindow);
        defineCustomElement('wix-bg-media', WixBgMedia);
    };

    var defineWixDropdownMenu = function defineWixDropdownMenu(externalServices) {
        var WixDropdownMenu = wixDropdownMenuWrapper(WixElement, externalServices, contextWindow);
        defineCustomElement('wix-dropdown-menu', WixDropdownMenu);
    };

    var defineWixVideo = function defineWixVideo(externalServices, environmentConsts) {
        var WixVideo = wixVideoWrapper(WixElement, externalServices, environmentConsts, contextWindow);
        defineCustomElement('wix-video', WixVideo);
    };

    var defineWixIframe = function defineWixIframe(externalServices) {
        var WixIframe = wixIframeWrapper(WixElement, externalServices);
        defineCustomElement('wix-iframe', WixIframe);
    };

    return {
        defineWixImage: defineWixImage,
        defineWixBgImage: defineWixBgImage,
        defineWixBgMedia: defineWixBgMedia,
        defineWixDropdownMenu: defineWixDropdownMenu,
        defineWixVideo: defineWixVideo,
        defineWixIframe: defineWixIframe
    };
}
