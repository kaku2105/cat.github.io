...
import {
    init as initDropdownMenuLayout
} from './dropdownMenuLayout';

function wixDropdownMenuWrapper(WixElement, services, contextWindow) {
    if (contextWindow === void 0) {
        contextWindow = window;
    }

    var dropdownMenuLayout = initDropdownMenuLayout(contextWindow);
    ...
    var WixDropdownMenu = /*#__PURE__*/ function(_WixElement) {
        ...
        _proto._waitForDomLoad = function _waitForDomLoad() {
            ...
            if (this._isDomReady()) {
                ...
                this._waitForDomReadyObserver = new contextWindow.MutationObserver(function() {
        ...
        _proto._observeChildrenResize = function _observeChildrenResize() {
            ...
            this._labelItems = menuItems.map(function(item) {
                return contextWindow.document.getElementById(item.getAttribute('id') + "label");
            });
        ...
        _proto.reLayout = function reLayout() {
            ...
            this._mutationIds.read = services.mutationService.measure(function() {
                var measureResult = dropdownMenuLayout.measure(_this5._id, services);
