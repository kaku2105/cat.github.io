...
var init = function init(contextWindow) {
    ...
    var checkForMarginMenu = function checkForMarginMenu(itemsContainer) {
        ...
        var itemCss = contextWindow.getComputedStyle(menuItem);
        var marginLeft = parseInt(itemCss.marginLeft, 10) || 0;
        var marginRight = parseInt(itemCss.marginRight, 10) || 0;
        return marginLeft + marginRight;
    };

    var roundScaleMeasurement = function roundScaleMeasurement(value) {
    ...
    var getDivExtraPixels = function getDivExtraPixels(itemsContainer, includeMargin) {
        var itemsContainerCss = contextWindow.getComputedStyle(itemsContainer);
    ...
    var getViewportHeight = function getViewportHeight() {
        return contextWindow.innerHeight;
    };
    ...
    var getLabelWidth = function getLabelWidth(labelNode, siteScale) {
        return roundScaleMeasurement(labelNode.getBoundingClientRect().width / siteScale);
    };
    ...
    var measureChildrenDimensions = function measureChildrenDimensions(id, domNodes, childrenIdsToMeasure, siteScale) {
    ...
    var measure = function measure(id, services) {
        var measures = {};
        var domNodes = {};
