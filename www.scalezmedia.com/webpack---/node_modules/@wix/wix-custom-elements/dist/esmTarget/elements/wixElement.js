...
function wixElementWrapper(services, contextWindow) {
    if (contextWindow === void 0) {
        contextWindow = window;
    }

    var WixElement = /*#__PURE__*/ function(_contextWindow$HTMLEl) {
        _inheritsLoose(WixElement, _contextWindow$HTMLEl);

        function WixElement() {
            // eslint-disable-line no-useless-constructor
            return _contextWindow$HTMLEl.call(this) || this;
        }
        ...
        _proto.observeChildren = function observeChildren(el) {
            ...
            if (!this.childListObserver) {
                this.childListObserver = new contextWindow.MutationObserver(function() {
        ...
        _proto.observeChildAttributes = function observeChildAttributes(el, attributes) {
            ...
            var attributesObserver = new contextWindow.MutationObserver(function() {
        ...
        _proto.unobserveChildren = function unobserveChildren() {
            ...
            if (this.childrenAttributesObservers) {
                for (var _iterator = _createForOfIteratorHelperLoose(this.childrenAttributesObservers), _step; !(_step = _iterator()).done;) {
