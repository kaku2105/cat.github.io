...
function wixBgMediaWrapper(WixElement, services, contextWindow) {
    ...
    var WixBgMedia = /*#__PURE__*/ function(_WixElement) {
        ...
        _proto.reLayout = function reLayout() {
            ...
            var container = contextWindow.document.getElementById("" + containerId);
            var page = contextWindow.document.getElementById("" + pageId);
            var measures = {};
            services.mutationService.measure(function() {
                ...
                var isFixedStyle = contextWindow.getComputedStyle(_this).position === 'fixed';
                var screenHeight = contextWindow.document.documentElement.clientHeight;
