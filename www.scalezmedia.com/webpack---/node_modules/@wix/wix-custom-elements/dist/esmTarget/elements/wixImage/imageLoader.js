...
var isEdge18 = function isEdge18(contextWindow) {
    return /Edge\/18/.test(contextWindow.navigator.userAgent);
};

var isIntersectionObserverSupported = function isIntersectionObserverSupported(contextWindow) {
    return contextWindow && 'IntersectionObserver' in contextWindow && 'IntersectionObserverEntry' in contextWindow && 'intersectionRatio' in contextWindow.IntersectionObserverEntry.prototype && 'isIntersecting' in contextWindow.IntersectionObserverEntry.prototype && !isEdge18(contextWindow);
...
var ImageLoader = /*#__PURE__*/ function() {
    function ImageLoader(mutationService, contextWindow) {
        ...
        if (isIntersectionObserverSupported(contextWindow)) {
            ...
            this.scrollEffectsIntersectionObserver = new contextWindow.IntersectionObserver(this.getScrollEffectsIntersectionHandler(), {
                rootMargin: '10% 0px'
            });
        }
    }
    ...
    _proto.setSrcAttribute = function setSrcAttribute(imageNode, isSvg, hasSrcset, src) {
    ...
    _proto.setImageSource = function setImageSource(wixImageNode) {
        ...
        var hasSrcset = imageNode.hasAttribute('srcset');
