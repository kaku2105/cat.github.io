...
import {
    init as initBgImageLayout
} from './bgImageLayout';
import {
    shouldStopImageLoad
} from '../../utils/imageUtils';

function wixBgImageWrapper(WixElement, services, environmentConsts, contextWindow) {
    if (contextWindow === void 0) {
        contextWindow = window;
    }

    var bgImageLayout = initBgImageLayout(contextWindow);
    ...
    var WixBgImage = /*#__PURE__*/ function(_WixElement) {
        ...
        _proto.reLayout = function reLayout() {
            ...
            services.mutationService.measure(function() {
                bgImageLayout.measure(imageId, measures, domNodes, {
