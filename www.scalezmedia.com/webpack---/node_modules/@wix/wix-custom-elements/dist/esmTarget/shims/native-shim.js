...
export default function(contextWindow) {
    if ( // No Reflect, no classes, no need for shim because native custom elements
        ...
        contextWindow.Reflect === undefined || contextWindow.customElements === undefined || // The webcomponentsjs custom elements polyfill doesn't require
        // ES2015-compatible construction (`super()` or `Reflect.construct`).
        contextWindow.customElements.hasOwnProperty('polyfillWrapFlushCallback')) {
        return;
    }

    var BuiltInHTMLElement = contextWindow.HTMLElement;

    contextWindow.HTMLElement =
        /** @this {!Object} */
        function HTMLElement() {
            return contextWindow.Reflect.construct(BuiltInHTMLElement, [],
                /** @type {!Function} */
