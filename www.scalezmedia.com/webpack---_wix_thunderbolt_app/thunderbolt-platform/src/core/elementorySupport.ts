...
import { CommonConfig, IPlatformLogger, SessionServiceAPI, WixCodeBootstrapData, Experiments } from '@wix/thunderbolt-symbols'
...
export async function importAndInitElementorySupport({
	...
	const options = { headers: { 'X-XSRF-TOKEN': csrfToken, commonConfig: JSON.stringify(commonConfig), Authorization: sessionService.getWixCodeInstance() } }
