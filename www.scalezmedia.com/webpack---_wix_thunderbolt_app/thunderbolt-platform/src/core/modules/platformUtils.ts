...
import type { BiUtils, IConsentPolicyManager, LinkUtils, ILocationManager, IPlatformUtils, SessionServiceAPI, IWarmupData, ClientSpecMapAPI } from '@wix/thunderbolt-symbols'
import {
	LINK_UTILS,
	WARMUP_DATA,
	PLATFORM_UTILS,
...
export default {
	...
	deps: [LINK_UTILS, SESSION_SERVICE, APPS_PUBLIC_API, PLATFORM_BI_LOGGER, LOCATION_MANAGER, PLATFORM_ESSENTIALS, WARMUP_DATA, CONSENT_POLICY_MANAGER, CLIENT_SPEC_MAP_API],
	name: PLATFORM_UTILS,
}
