...
function PlatformEssentials(bootstrapData: BootstrapData, sessionService: SessionServiceAPI) {
	...
	const setBaseUrlToExternalBaseUrl = experiments['specs.thunderbolt.essentials_base_url_external_base_url'] || experiments['specs.thunderbolt.essentials_base_url_external_base_url_loggedIn']
