...
function getModelFromContext(id, context) {
    ...
    const lazyFactoryID = editor_elements_conventions_1.getLazyFactoryID(id);
...
async function getModel(id) {
    const factory = await getGlobalModel(editor_elements_conventions_1.getLazyFactoryID(id));
    if (factory && !factory.invoked) {
        factory.invoked = true;
        factory();
    }
