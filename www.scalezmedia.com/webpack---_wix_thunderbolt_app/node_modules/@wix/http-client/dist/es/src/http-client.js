...
var HttpClient = /** @class */ (function() {
    ...
    HttpClient.prototype.getHeaders = function(requestOptions, signedInstance, urlObject) {
        if (typeof this.opts.createHeaders === 'function') {
            return this.getCustomHeaders(requestOptions, signedInstance);
        }
        var wixHeadersOpts = {
    ...
    HttpClient.prototype.getCustomHeaders = function(requestOptions, signedInstance) {
        ...
        return __assign(__assign({}, customHeaders), authHeader);
    };
