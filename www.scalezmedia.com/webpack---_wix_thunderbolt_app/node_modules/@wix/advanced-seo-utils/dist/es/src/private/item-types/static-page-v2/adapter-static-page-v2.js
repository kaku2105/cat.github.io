...
export default {
    ...
    getData: function(item) {
        ...
        var data = (_a = {},
            ...
            _a[IDs.INSTALLED_APPS] = getRawValue(item, "context." + CONTEXT_PROPS.INSTALLED_APPS),
            _a[IDs.SEARCH_PAGE_SLUG] = getSiteSearchSlug(getRawValue(item, "context." + CONTEXT_PROPS.INSTALLED_APPS)),
