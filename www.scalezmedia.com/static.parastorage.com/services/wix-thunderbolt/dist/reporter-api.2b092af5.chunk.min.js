            ...
            "undefined" != typeof self && self, e.exports = function() {
                ...
                return function() {
                        ...
                        h = function(e, n, t, r) {
                            ...
                            e.forEach((function(e) {
                                (function(e, n, t, r) {
                                    ...
                                    }), r.context.appDefId = r.context.appDefId || i, n.events[e] ? n.events[e](a, r) : []) : r && r.preventDefaultChannels ? [] : [
                                        [e, a].concat(r ? [r] : [])
                                    ]
                    ...
                    var b = ["type"],
                        ...
                        T = {
                            ...
                            InitiateCheckout: function(e) {
                                return [
                                    ["track", "InitiateCheckout", c()({}, L(O(e)), e.contents && {
                            ...
                            AddPaymentInfo: function(e) {
                                return [
                                    ["track", "AddPaymentInfo", c()({}, L(O(e)), e.contents && {
                                        content_ids: e.contents.map((function(e) {
                                            return e.id
                                        })),
                                        content_type: "product"
                            ...
                            Purchase: function(e, n) {
                                if (n.isFBServerEventsEnabled) {
                                    var t = c()({}, L(O(e)), e.contents && {
                                        ...
                                        o = ["track", "Purchase", c()({}, t), {
                                            eventID: r
                                        }],
                                        i = ["trackCustom", "WixOrderPlaced", c()({}, t), {
                                            eventID: r
                                        }];
                                    return [].concat(A(e) ? [] : [o], [i])
                                }
                                return [
                                    ["track", "Purchase", c()({}, L(O(e)), e.contents && {
                                        content_ids: e.contents.map((function(e) {
                                            return e.id
                                        })),
                                        content_type: "product"
                        ...
                        G = {
                            ...
                            AddProductImpression: function(e) {
                                var n = (e.contents || []).map((function(e) {
                                    return ["ec:addImpression", C(e, N)]
                                }));
                                return [
                                    ["require", "ec"]
                                ].concat(n).concat([
                                    ["send", "event", S(e.origin), "Product Impressions", {
                                        nonInteraction: !0
                                    }]
                                ])
                            },
                            ClickProduct: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", S(e.origin), "Product Click", n]
                                ])
                            },
                            ViewContent: function(e) {
                                var n = e.name ? e.name : "(not set)";
                                return [
                                    ...
                                    ["ec:addImpression", C(e, N)]
                                ]).concat([
                                    ["ec:setAction", "detail"]
                                ]).concat([
                                    ["send", "event", S(e.origin), "View Content", n, {
                                        nonInteraction: !0
                                    }]
                                ])
                            },
                            AddToCart: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", S(e.origin), "Add to Cart", n]
                                ])
                            },
                            RemoveFromCart: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", S(e.origin), "Remove from Cart", n]
                                ])
                            },
                            InitiateCheckout: function(e) {
                                var n = (e.contents || []).map((function(e) {
                                        return ["ec:addProduct", C(e, N)]
                                    })),
                                    t = C({
                                        option: e.option
                                    }, N);
                                return [
                                    ...
                                    ["send", "event", S(e.origin), "Initiate Checkout"]
                                ])
                            },
                            StartPayment: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", S(e.origin), "Start Payment"]
                                ])
                            },
                            AddPaymentInfo: function(e) {
                                var n = C({
                                ...
                                return [
                                    ...
                                    ["send", "event", S(e.origin), "Add Payment Info"]
                                ])
                            },
                            CheckoutStep: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", S(e.origin), "Checkout Step " + n.step]
                                ])
                            },
                            Purchase: function(e) {
                                var n = (e.contents || []).map((function(e) {
                                ...
                                return ["id", "affiliation", "revenue", "tax", "shipping", "coupon"].forEach((function(n) {
                                    ...
                                    ["ec:setAction", "purchase", C(t, N)]
                                ]).concat([
                                    ["send", "event", S(e.origin), "Purchase"]
                                ])
                            },
                            Lead: function(e) {
                                var n = e.category,
                    ...
                    var Q = Object.keys(J).reduce((function(e, n) {
                        ...
                        te = Object.keys(ee).reduce((function(e, n) {
                            return e[n] = function(e, t) {
                                ...
                                return t.context && t.context.appDefId && (r.appId = t.context.appDefId), t.preventDefaultChannels ? [] : ("Purchase" === n && (r.features = W({
                    ...
                    var ie, ae, ce, ue, se = {
                        ...
                        Oe = function(e, n) {
                            var t, r;
                            t = Le, r = e, Object.prototype.hasOwnProperty.call(t, r) || (Le[e] = n)
                        },
                        Te = function(e, n) {
                            Object.keys(Le).forEach((function(t) {
                                Le[t].call(void 0, e, function(e) {
                        ...
                        Se = ((ce = {})[Ne.FACEBOOK_PIXEL] = T, ce[Ne.GOOGLE_ANALYTICS] = G, ce[Ne.GOOGLE_TAG_MANAGER] = X, ce[Ne.WIX_ANALYTICS] = Q, ce[Ne.BI_ANALYTICS] = te, ce[Ne.GTAG] = se, ce[Ne.GLOBAL_GTAG] = Ee, ce[Ne.VK_RETARGETING] = {
                            PageView: function() {
                                return [
                                    []
                                ]
                            }
                        }, ce[Ne.YANDEX_METRICA] = Pe, ce),
                        Ge = ((ue = {})[Ne.WIX_DEVELOPERS_ANALYTICS] = function(e, n) {
                            if (e) {
                                if (window) {
                        ...
                        Re = function() {
                            ...
                            return n.isChannelPredefined = function(e) {
                                ...
                                e.events = Se[e.name], e.events.publicTracking && e.events.publicTracking instanceof Function && e.events.publicTracking()
                                ...
                                this.isChannelValid(e) && (Se[e.name] = e.events)
                            }, e
                        }(),
                        De = new Re,
                        Ve = function(e) {
                            void 0 === e && (e = []), e.forEach(De.addChannel)
                        },
                        je = function(e, n) {
                            De.addListener(e, n)
                        },
